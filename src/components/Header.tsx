      ...
      <div className="container py-4">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex md:items-center md:space-x-4">
            <Link to="/home" className="text-primary hover:text-accent">
              Home
            </Link>
            <Link to="/projects" className="text-primary hover:text-accent">
              Projects
            </Link>
            <Link to="/roadmap" className="text-primary hover:text-accent">
              Roadmap
            </Link>
            <Link 
              to="/invest" 
          ...
          <div className="md:hidden">
            <button
              type="button"
              className="inline-flex items-center justify-center p-2 text-gray-400 rounded-md hover:text-primary hover:bg-gray-100"
          ...
          <div className="md:hidden">
            <div className="flex flex-col px-2 pt-2 pb-3 space-y-1">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="block px-3 py-2 text-base font-medium text-white rounded-md bg-accent flex items-center"
                onClick={() => setMobileMenuOpen(false)}
              >
                Invest in Rory
              </a>
